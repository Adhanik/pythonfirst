...
# Take input from user a number and computer will generate a secret number for us to guess between
...
def guess(x):
    ...
    for i in range(1,x):
        if i ==random_number:
            ...
            #continue #if continue is used here, even after finding the number, continue will force the loop to start at next iteration
            break       
        else:
            pass
